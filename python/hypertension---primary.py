...
codes = [{"code":"7Q01.00","system":"readv2"},{"code":"G202.00","system":"readv2"},{"code":"6624","system":"readv2"},{"code":"G203.00","system":"readv2"},{"code":"G20z.11","system":"readv2"},{"code":"6146200","system":"readv2"}];
REQUIRED_CODES = 1;
