...
codes = [{"code":"G244.00","system":"readv2"},{"code":"G24..00","system":"readv2"},{"code":"G24z100","system":"readv2"},{"code":"G24zz00","system":"readv2"},{"code":"G24z.00","system":"readv2"},{"code":"I15","system":"readv2"}];
REQUIRED_CODES = 1;
